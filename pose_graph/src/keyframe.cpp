...
void KeyFrame::computeBRIEFPoint() {
  ...
  if (1)
     ...
     *void cv::FAST	(
     *	InputArray 	image,
     *关键点所在的灰度图像。 std::vector< KeyPoint > & 	keypoints,
     *在图像上检测到关键点 int 	threshold,
     *中心像素的强度与该像素周围圆的像素之间的差异的阈值 bool nonmaxSuppression
     *= true 		是否对检测到的角点（关键点）应用非最大抑制
     *)
     */
